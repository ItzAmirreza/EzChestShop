...
public class ImprovedOfflinePlayer_v1_19_R2 extends ImprovedOfflinePlayer {

    private File file;
    private NBTTagCompound compound;

    public ImprovedOfflinePlayer_v1_19_R2() {
        super();
    }

    public ImprovedOfflinePlayer_v1_19_R2(OfflinePlayer player) {
        super(player);
    }

    @Override
    public ImprovedOfflinePlayer fromOfflinePlayer(OfflinePlayer player) {
        return new ImprovedOfflinePlayer_v1_19_R2(player);
    }
