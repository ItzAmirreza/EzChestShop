...
public class ChannelHandler_v1_15_R1 extends ChannelInboundHandlerAdapter {
    ...
    public ChannelHandler_v1_15_R1(Player player) {
        this.player = player;
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        if (msg instanceof PacketPlayInUpdateSign) {
            for (Map.Entry<SignMenuFactory, UpdateSignListener> entry : v1_15_R1.getListeners().entrySet()) {
