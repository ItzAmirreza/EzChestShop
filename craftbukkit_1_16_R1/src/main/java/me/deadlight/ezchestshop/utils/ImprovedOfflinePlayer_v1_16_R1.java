...
public class ImprovedOfflinePlayer_v1_16_R1 extends ImprovedOfflinePlayer {

    private File file;
    private NBTTagCompound compound;

    public ImprovedOfflinePlayer_v1_16_R1() {
        super();
    }

    public ImprovedOfflinePlayer_v1_16_R1(OfflinePlayer player) {
        super(player);
    }

    @Override
    public ImprovedOfflinePlayer fromOfflinePlayer(OfflinePlayer player) {
        return new ImprovedOfflinePlayer_v1_16_R1(player);
    }
