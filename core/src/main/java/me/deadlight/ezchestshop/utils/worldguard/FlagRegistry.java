...
public class FlagRegistry {
    ...
    public static void onLoad() {
        ...
        CREATE_ADMIN_TRADE_SHOP = registerStateFlag("ecs-create-admin-trade-shop", true);
        ...
        REMOVE_ADMIN_TRADE_SHOP = registerStateFlag("ecs-remove-admin-trade-shop", true);
        ...
        USE_ADMIN_TRADE_SHOP = registerStateFlag("ecs-use-admin-trade-shop", true);
    }
