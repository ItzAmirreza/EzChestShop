...
public class ChannelHandler_v1_20_R2 extends ChannelInboundHandlerAdapter {
    ...
    public ChannelHandler_v1_20_R2(Player player) {
        this.player = player;
    }
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws NoSuchFieldException, IllegalAccessException {
        ...
        if (msg instanceof ServerboundSignUpdatePacket) {
            for (Map.Entry<SignMenuFactory, UpdateSignListener> entry : v1_20_R2.getListeners().entrySet()) {
