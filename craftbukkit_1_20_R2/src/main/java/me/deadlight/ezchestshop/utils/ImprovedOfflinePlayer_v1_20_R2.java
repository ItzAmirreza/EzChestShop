...
public class ImprovedOfflinePlayer_v1_20_R2 extends ImprovedOfflinePlayer {

    private File file;
    private CompoundTag compound;

    public ImprovedOfflinePlayer_v1_20_R2() {
        super();
    }

    public ImprovedOfflinePlayer_v1_20_R2(OfflinePlayer player) {
        super(player);
    }

    @Override
    public ImprovedOfflinePlayer fromOfflinePlayer(OfflinePlayer player) {
        return new ImprovedOfflinePlayer_v1_20_R2(player);
    }
    ...
    public boolean loadPlayerData() {
        try {
            for(World w : Bukkit.getWorlds()) {
                ...
                if(this.file.exists()){
                    this.compound = NbtIo.readCompressed(new FileInputStream(this.file));
                    return true;
                }
            }
        }
