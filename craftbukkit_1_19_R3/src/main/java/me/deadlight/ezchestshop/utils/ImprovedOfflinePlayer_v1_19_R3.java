...
public class ImprovedOfflinePlayer_v1_19_R3 extends ImprovedOfflinePlayer {

    private File file;
    private NBTTagCompound compound;

    public ImprovedOfflinePlayer_v1_19_R3() {
        super();
    }

    public ImprovedOfflinePlayer_v1_19_R3(OfflinePlayer player) {
        super(player);
    }

    @Override
    public ImprovedOfflinePlayer fromOfflinePlayer(OfflinePlayer player) {
        return new ImprovedOfflinePlayer_v1_19_R3(player);
    }
